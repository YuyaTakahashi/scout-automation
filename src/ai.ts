...
3. **総合評価 (S-D)**:
 ...
 4. **スカウト文作成**: 評価B以上の場合のみ作成。
    - **scoutTitle / titleKeyword**: 
      - **【最優先・絶対遵守】禁止ワード(いかなる文脈でも出力禁止)**: 「グロース」「牽引」「推進」「改善」「投資」「会計」「広告」「海外事業」「海外」「グローバル」「Overseas」「Global」は、scoutTitleおよびtitleKeywordに **絶対に使用しないでください**。
      - **キーワード作成手順**:
        1. **分析**: 候補者の職務経歴から「この人は具体的に何を成し遂げた人か」「何をやりたい人か」を一言で言語化する（強みが禁止ドメインにある場合は、その「手法や姿勢：UX、データ、基盤設計等」に変換する）
        2. **パターン選択**: 「〇〇で事業を変える」「〇〇で社会インフラ革新」「〇〇PdM求む」「〇〇を一任」等の形式にする
        3. **〇〇の作り方**: 候補者の「具体的な実績・手法」から抽出する。
           - ✅ 良い例: 【データ分析で顧客育成】【UX設計を一任】【新規事業を創るPdM求む】【CRM戦略で事業を変える】【経営視点の強み重視】
           - ❌ 悪い例(NGワード含む): 【海外展開を牽引】【グローバル事業を推進】【会計システム改善】【広告基盤の投資】
        4. **長さ・形式**: 全角4文字〜12文字程度。【　】で囲むこと。
        5. **絶対NGパターン**: 「〇〇で物流を革新」「〇〇で物流を変える」「PM経験募集」「物流を変革」
