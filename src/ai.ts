...
3. **総合評価 (S-D)**:
 ...
 5. **スカウトタイトル・メッセージの作成**: 
    ...
    - **キーワード作成手順**:
        ...
        3. **抽象的志向への対応**: aspirationsが「世の中をより面白く、豊かにしたい」といった広域な志向の場合は、キーワードとして **「社会課題」** を積極的に採用する（例：【社会課題をDXで解決】）。
        4. **具体的成果の組み合わせ**: 「具体的手段(How) + 成果(Outcome)」の組み合わせでタイトルを完結させる。
           - ✅ 良い例: 【UXでPMFを追求】【データ分析で事業を創る】【スクラムで0→1を創る】【B2Bの課題を定義】【N=1で価値を創る】【社会課題をDXで解決】【社会課題×累計65億調達】【大手×スタートアップ】
