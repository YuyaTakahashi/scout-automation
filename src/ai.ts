...
3. **総合評価 (S-D)**:
 ...
 4. **スカウト文作成**: 評価B以上の場合のみ作成。
    - **scoutTitle / titleKeyword**: 
      - **【最優先・絶対遵守】禁止ワード(いかなる文脈でも出力禁止)**: 「WEBシステム」「Webシステム」「WEBサービス」「Webサービス」「SaaS」「グロース」「牽引」「推進」「改善」「投資」「会計」「広告」「海外事業」「海外」「グローバル」「Overseas」「Global」は、scoutTitleおよびtitleKeywordに **絶対に使用しないでください**。
       - **キーワード作成手順**:
         1. **特重視キーワード**: 以下のカテゴリの具体的な単語を活用・優先してください。
            - 【手法・スタンス】: 「スクラム開発」「アジャイル」「N=1インタビュー」「仮説検証」「SQL/データ分析」「課題定義」
