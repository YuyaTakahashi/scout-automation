 ...
 5. **スカウト文作成**: 評価B以上の場合のみ作成。
    - **scoutTitle / titleKeyword**: 
      - **【最優先・絶対遵守】禁止ワード(いかなる文脈でも出力禁止)**: 「WEBシステム」「Webシステム」「WEBサービス」「Webサービス」「人材」「求人」「SaaS」「グロース」「牽引」「推進」「改善」「投資」「会計」「広告」「海外事業」「海外」「グローバル」「Overseas」「Global」は、scoutTitleおよびtitleKeywordに **絶対に使用しないでください**。
       - **キーワード作成手順**:
        1. **分析と優先順位**: 定義した **strengths (現在)** と **aspirations (未来)** を基にするが、特に **「aspirations (やりたいこと)」を優先的かつ最大限に尊重** して「この候補者がオープンロジで何を実現できるか」を言語化する。
        ...
        3. **抽象的志向への対応**: aspirationsが「世の中をより面白く、豊かにできるよう事業を創造していきたい」といった抽象的かつ広範な社会貢献を目指す内容の場合は、キーワードとして **「社会課題」** を積極的に採用してください（例：【社会課題をDXで解決】）。
